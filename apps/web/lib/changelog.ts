...
export const CHANGELOG: ChangelogEntry[] = [
  {
    ...
    bullets: [
      ...
      'The player bar on a phone is back to one clean row: the artwork, the song name with room to actually read it (it scrolls when it is too long for even that), and one big play button. Previous, next and the queue are in the full-screen player, which opens when you tap the bar. The bar and the row of Home, Search and Library now sit clear of the Android buttons at the bottom of the screen instead of hiding behind them.',
    ],
  },
  {
