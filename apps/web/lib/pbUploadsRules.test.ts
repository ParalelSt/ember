...
// and orphans the audio/cover files on disk. The real behavior is proven
// against a live PocketBase in docs/reports/bughunt-2026-09-24/ (fixture
// too heavy to spin up here); this is the fast static guard against
// regressing the rule text itself.
