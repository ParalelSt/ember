      ...
      <div className="flex-1 min-h-0 flex flex-col min-w-0">
        ...
        >
          ...
          <div ref={scrollerRef} data-app-scroller className="flex-1 min-h-0 overflow-y-auto">
            {/* Desktop only: a fade at the top of the scroller, so content
                scrolling up under the search pill fades out instead of
                being cut off mid-line. The owner rejected a padded gap
                (it pushed the page and its scrollbar down), so this takes
                no layout space: `sticky top-0` glues it to the scroller's
                visible top edge, the `h-0 overflow-visible` wrapper keeps
                it out of the flow, and the gradient inside overflows
                downward over whatever is scrolled under it. At scrollTop 0
