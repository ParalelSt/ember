  ...
  return (
    <div>
      ...
      <p className="text-meta">
        Nothing to pick right now. The last question, how to attach screenshots and recordings to a
        bug report or a request, was answered with the Attach button and its thumbnails, and it
