...
export async function GET(_req: NextRequest, ctx: RouteContext<'/api/tabs/generated/[trackId]'>) {
  try {
    await requireUser();
...
export async function POST(request: NextRequest, ctx: RouteContext<'/api/tabs/generated/[trackId]'>) {
  try {
