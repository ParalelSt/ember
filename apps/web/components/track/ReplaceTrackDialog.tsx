              ...
              return (
                ...
                >
                  {c.artworkUrl ? (
                    ...
                    <img src={c.artworkUrl} alt="" className="h-10 w-10 rounded shrink-0 object-cover bg-black" />
                  ) : (
                    <div className="h-10 w-10 rounded shrink-0 bg-card" />
                  )}
                  <div className="min-w-0 flex-1">
                    <div className="truncate text-sm font-medium">{c.title}</div>
                    <div className="truncate text-xs text-muted-foreground">{c.artist}</div>
                  </div>
                  <div className="shrink-0 text-xs tabular-nums text-muted-foreground">{fmt(c.durationSec)}</div>
                </button>
              );
            })}
          </div>
