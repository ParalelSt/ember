    ...
    fun drain() {
        ...
        while (true) {
            ...
            if (reason is String && !wasCancelled) {
                // The only place this failure becomes visible to the user: the
                // web logger picks the event up and a bug report carries it.
                // Emitted here rather than in the service shell because this is
