...
node tests/pranks-ui.test.mjs                       # or: npm run test:pranks-ui (admin pings a playing target in a second browser context, uploads a sound and plays it over the target's ducked music, library and media gate, rules, switch, caps, 45 s expiry; PB restarted with this branch's pb_hooks)
